...
>       * **File containing the #1 reads** - *SRR7657883.subset_2M.sra_1.fastq.gz*
>       * **File containing the #2 reads** - *SRR7657883.subset_2M.sra_2.fastq.gz*
...
further improves the compression of the SAM to BAM. We will use the `sort` tool.

The general command is:

`samtools sort -o my_sample.sorted.bam my_sample.sam`

Where `-o` is the output file name.
